...
class FlutterContactPicker {
  ...
  static Future<List<String>> getAvailableProperties() => ContactPickerPlatform.instance.getAvailableProperties();
  ...
  static Future<PhoneContact> pickPhoneContact(
    {
      ...
      ContactPickerPlatform.instance.pickPhoneContact(askForPermission: askForPermission);
  ...
  Future<List<PhoneContact>> pickPhoneContacts(
    {
      ...
      return ContactPickerPlatform.instance.pickPhoneContacts(askForPermission: askForPermission, multiple: multiple);
    }

  /// Picks a [IdentifiedContact].
  /// Requires [hasPermission] on Android 11+ and xiaomi devices
  /// See Also [PhoneContact]
  static Future<IdentifiedContact> pickIdentifiedContact(
    {

      /// Whether to automatically request the required permission if needed or not (See [requestPermission] and [hasPermission])
      bool askForPermission = true
    }) async =>
      ContactPickerPlatform.instance.pickIdentifiedContact(askForPermission: askForPermission);
  ...
  static Future<EmailContact> pickEmailContact(
    {
      ...
      ContactPickerPlatform.instance.pickEmailContact(askForPermission: askForPermission);
  ...
  Future<List<EmailContact>> pickEmailContacts(
    {
      ...
      return ContactPickerPlatform.instance.pickEmailContacts(askForPermission: askForPermission, multiple: multiple);
    }
  ...
  static Future<FullContact> pickFullContact(
    {
      ...
      ContactPickerPlatform.instance.pickFullContact(askForPermission: askForPermission);
  ...
  Future<List<FullContact>> pickFullContacts(
    {
      ...
      return ContactPickerPlatform.instance.pickFullContacts(askForPermission: askForPermission, multiple: multiple);
    }
